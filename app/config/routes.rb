...
App::Application.routes.draw do
  ...
  get 'playlist_management/:channel_playlist/append_episode/:episode_id', to: 'playlist_management#append_episode'
  get 'playlist_management/:channel_playlist/append_jingle/:jingle_id', to: 'playlist_management#append_jingle'
